...
I chose two datasets related to soccer because soccer has been my biggest passion since I was three years old. The first dataset, "Fifa Audience", records the.
...
fifa
fifa %>% pivot_longer(cols = 5:10, names_to="confederation")
```
